...
document.addEventListener('DOMContentLoaded', () => {
  fetch("https://collectra.herokuapp.com/statistics.json").then(function (response) {
    ...
    renderChart(data["by_device_model"], "devices-breakdown", "tol-rainbow", false)
    renderChart(data["by_ios_version"], "version-breakdown", "tol-rainbow", false)
    renderChart(data["by_electra_version"], "electra-version-breakdown", "tol-rainbow", false)
  })
});
